...
client.on('message', async msg => {
    ...
    if (command === 'ping'){
      ...
      if (!args.length) { return msg.reply('You need to supply a valid message for Watson Assistant!'); }
      const wa_comm_text = args.join(' ');
      client.commands.get('Watson Assistant').execute(msg, wa_comm_text);
    }
